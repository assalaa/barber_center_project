...
import 'package:barber_center/screens/welcome_screen/welcome_screen_provider.dart';
...
class WelcomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<WelcomeScreenProvider>(
      ...
      child: Consumer<WelcomeScreenProvider>(builder: (context, provider, _) {
        return Scaffold(
          body: Stack(
            children: [
              Image.asset(
